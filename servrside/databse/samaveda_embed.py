...
# -------- Load JSON --------
verses = json.load(open("../parsing/samaveda_merged.json", "r", encoding="utf-8"))
...
# -------- Save Index + Metadata --------
faiss.write_index(index, "samaveda.index")
with open("samaveda_meta.pkl", "wb") as f:
    pickle.dump(verses, f)

print("✅ Samaveda index built and saved")
